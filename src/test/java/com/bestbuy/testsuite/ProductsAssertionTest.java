...
public class ProductsAssertionTest {
    ...
    public void test007() {
        ...
        Arrays.asList("data[3].price", equalTo(4.99)); // i have used array.aslist as expected result was expected "<4.99> so i have used to array list to change it into list.
